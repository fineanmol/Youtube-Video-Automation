...
async function main() {
    try {
        ...
        const browser = await puppeteer_1.default.launch({
            ...
            headless: false,
            userDataDir: '/Users/anmolagarwal/Library/Application Support/Google/Chrome Beta',
        ...
        const videoFiles = await readdir(VIDEOS_FOLDER);
        // Iterate through the video files and upload/schedule them
        for (let i = 0; i < videoFiles.length; i++) {
            const videoFile = videoFiles[i];
            const videoPath = path_1.default.join(VIDEOS_FOLDER, videoFile);
            // Upload the video
